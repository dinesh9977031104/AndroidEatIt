...
public class DummyCartActivityCode {
   /* package com.patidar.dinesh.androideatit;
...
import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;
    ...
    public class Cart extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
            ...
            btnPlace.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (cart.size() > 0)
                        ...
                        Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Your cart is empty!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        private void showAlertDialog() {
            ...
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(com.patidar.dinesh.androideatit.Cart.this);
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    if (b) {
                        if (Common.currentUser.getHomeAddress() != null ||
                            ...
                            Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Please Update your home address", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            });
                        ...
                        mGoogleMapService.getAddressName(String.format("https://maps.googleapis.com/maps/api/geocode/json?latlng=%f,%f&sensor=false",
                                ...
                                .enqueue(new Callback<String>() {
                                    ...
                                    public void onFailure(Call<String> call, Throwable t) {
                                        ...
                                        Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "" + t.getMessage(), Toast.LENGTH_LONG).show();
                                    }
                                });
                    }
                }
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (!rdiShipToAddress.isChecked() && !rdiHomeAddress.isChecked()) {
                        if (shippingAddress != null)
                            ...
                            Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Please Select Address or select option address ", Toast.LENGTH_SHORT).show();
                            //remove fragment
                    ...
                    if (TextUtils.isEmpty(address)) {
                        Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Please Select Address/select option address ", Toast.LENGTH_SHORT).show();
                        //remove fragment
                        getFragmentManager().beginTransaction()
                                .remove(getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment))
                                .commit();
                    ...
                    if (!rdiCOD.isChecked() && !rdiCOD.isChecked()) {
                        Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Please Select Payment options", Toast.LENGTH_SHORT).show();
                        //remove fragment
                        getFragmentManager().beginTransaction()
                                .remove(getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment))
                                .commit();
                                    ...
                                    public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                        ...
                                        if (response.code() == 200) {
                                            ...
                                            if (response.body().success == 1) {
                                                Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Thank you, Order Place", Toast.LENGTH_SHORT).show();
                                                finish();
                                            } else {
                                                Toast.makeText(com.patidar.dinesh.androideatit.Cart.this, "Failed !!!", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    }

package com.patidar.dinesh.androideatit.Database;
...
public class Database extends SQLiteAssetHelper {
    ...
    //favorites
    public void addToFavorites(Favorits food){
        SQLiteDatabase db = getReadableDatabase();
    ...
    public List<Favorits> getAllFavorites(String userPhone) {
        SQLiteDatabase db = getReadableDatabase();
        SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
        ...
        final List<Favorits> result = new ArrayList<>();
        if (c.moveToFirst()) {
            do {

                result.add(new Favorits(
